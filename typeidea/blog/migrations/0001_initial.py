# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-07-20 09:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (1, '删除')], default=1, verbose_name='状态')),
        ...
        migrations.AddField(
            model_name='post',
            name='tag',
            field=models.ManyToManyField(to='blog.Tag', verbose_name='作者'),
        ),
    ]
